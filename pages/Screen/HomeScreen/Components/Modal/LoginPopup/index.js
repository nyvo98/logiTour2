...
class LoginPopup extends React.PureComponent {
  ...
  componentDidMount () {
    window.addEventListener('keydown', e => {
      if (e.getModifierState) { this.setState(state => ({ ...state, isCaplock: !!e.getModifierState('CapsLock') })) }
    })
  }
  ...
  onLogin = async () => {
    ...
    if (resLogin) {
      if (resLogin.errMess) {
        showNotification(
          messages.loginFail || '',
          messages[resLogin.errMess] || '', 'error'
        )
      } else {
        ...
        <div className='LoginContainer login-responsive'>
          ...
          >
            ...
            <div className='input-container MB50'>
              ...
              <div className='caplockWarning'>
                {isCaplock ? messages.caplockIsOn || 'Warning: Your caplock is currently on' : ''}
              </div>
          ...
          <div className='socialBox'>
            ...
            <div className='sign-up-row MT40'>
              ...
              <p
                onClick={this.onChangeRouter('signup')}
