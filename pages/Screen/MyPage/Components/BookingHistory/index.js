...
class BookingHistory extends Component {
  ...
  async componentDidMount () {
    ...
    renderBookingList = () => {
      ...
      return <BookingList list={bookingList && bookingList.slice(0, page * limit)} />
    };
    ...
    render () {
      ...
      return (
        <div className='booking-history-container MT100 PT50'>
          ...
          {/* Pagination */}
          <p className='MT68 MB35 dark text text-center'>{bookingList && (bookingList.length > limit ? limit * page : bookingList.length)} {messages.of} {bookingList && bookingList.length}</p>
